...
나는 여기서 my-cursor를 떠올렸다. `~/.cursor/commands/cb/*.md`가 **repo 밖 personal harness**이고, 팀 레포 `.claude`와 **역할이 겹치지 않게** 나누는 게 중요하다. [skill-is-code](https://changbaebang.github.io/2026-05-22-skill-is-code-iterate-it/)에서 쓴 것처럼, **실전에서 틀린 걸 스킬 정의에 다시 써 넣는 루프**가 하네스의 본체다.
...
| Hooks self-improve | E2E 실패 → 스킬 수정 루프 ([skill-is-code](https://changbaebang.github.io/2026-05-22-skill-is-code-iterate-it/)) |
